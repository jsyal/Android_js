 ...
 *  Written:       11/18/2014
 *  
 *  EditKid allows the parent to edit kid information with actions such as delete, add task, and view task list
 *
 *----------------------------------------------------------------*/
...
public class EditKid extends Activity{
	EditText kidName;
	EditText taskName;
	Button btnaddtask;
	Button btnshowTask;
	...
	@Override
	    public void onCreate(Bundle savedInstanceState) {
			...
			setContentView(R.layout.activity_editkid);
        ...
        if (id == R.id.menu_homepage) {
            //Create Intent for Parent home Activity
